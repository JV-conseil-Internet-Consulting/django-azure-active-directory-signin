...
class IdentityContextData(object):
    ...
    def clear(self) -> None:
        ...
        self._nonce = None
        self._state = None
        self._id_token_claims = (
            {}
        )  # does this belong here? yes, Token/claims customization. TODO: if it does, add getter/setter, # ID tokens aren't cached so store this here?
